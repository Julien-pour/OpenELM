...
path="" 
python run_elm.py --config-name={config_name} seed=$seed env.seed=$seed qd.seed=$seed qd.save_snapshot_interval=10 model.model_path=$full_path model_name=$model_names_id
kill $SERVER_PID
